...
import os
import pandas as pd
outfile = open("NATMUE_DEL_01-12-2020_ANAND.csv", "w", newline='',encoding="utf-8")
...
d = {"folder":file_extn_list,"link":website_list}
df = pd.DataFrame(data=d )
df.to_excel('ngma01122020.xlsx', header=True, index=False)